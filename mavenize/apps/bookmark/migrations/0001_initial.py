...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bookmark_bookmarkgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal('bookmark', ['BookmarkGroup'])

        # Adding M2M table for field bookmarks on 'BookmarkGroup'
        db.create_table('bookmark_bookmarkgroup_bookmarks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bookmarkgroup', models.ForeignKey(orm['bookmark.bookmarkgroup'], null=False)),
            ('bookmark', models.ForeignKey(orm['bookmark.bookmark'], null=False))
        ))
        db.create_unique('bookmark_bookmarkgroup_bookmarks', ['bookmarkgroup_id', 'bookmark_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('bookmark_bookmarkgroup')

        # Removing M2M table for field bookmarks on 'BookmarkGroup'
        db.delete_table('bookmark_bookmarkgroup_bookmarks')
    ...
    models = {
        ...
        'bookmark.bookmarkgroup': {
            ...
            'bookmarks': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['bookmark.Bookmark']", 'symmetrical': 'False'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
